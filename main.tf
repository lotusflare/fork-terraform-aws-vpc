...
resource "aws_subnet" "public" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.public_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.public_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "private" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.private_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.private_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "outpost" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.outpost_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.outpost_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "database" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.database_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.database_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "redshift" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.redshift_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.redshift_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "elasticache" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.elasticache_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.elasticache_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "intra" {
  ...
  ipv6_cidr_block = (var.enable_ipv6 || var.ipv6_ipam_pool_id != null) && length(var.intra_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.this[0].ipv6_cidr_block, 8, var.intra_subnet_ipv6_prefixes[count.index]) : null
